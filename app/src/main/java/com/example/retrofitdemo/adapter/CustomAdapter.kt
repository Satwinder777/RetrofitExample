...
class CustomAdapter(var context: Context, val mList: MutableList<Result>) : RecyclerView.Adapter<CustomAdapter.ViewHolder>() {
...
//            id.text = result.bio
//            Quote.text = result.quoteCount.toString()
